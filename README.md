...
and 4 product categories to uncover revenue drivers, 
profitability trends and customer behavior patterns using 
Excel, Power BI and DAX.

## Key Insights
- Apparel is the highest profit category at $21,129 — 
  outperforming Footwear at $16,638
- Online channel drives the highest revenue among all 
  sales channels
- Average customer rating of 4.0+ across all categories
- End-to-end data validation ensured 100% data integrity 
